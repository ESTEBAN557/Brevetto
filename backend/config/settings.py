"""Configuración de Django para Brevetto.

Las variables sensibles se leen del entorno mediante django-environ.
"""
...
AWS_QUERYSTRING_EXPIRE = env("PRESIGNED_URL_EXPIRATION_SECONDS")
...
PORTAL_SESSION_TTL_SECONDS = env.int("PORTAL_SESSION_TTL_SECONDS", default=1800)
SIMPLE_JWT = {
